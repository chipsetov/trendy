<div class="global-content">
    ...
    <div class="row">
        <div class="col-sm-2 left-dates"><img
                    src="<? echo get_template_directory_uri() . "/images/category-icon-video.png" ?>"
                    alt="category-icon-video.png">
        ...
        <div class="col-sm-10 standard-post">
            <?php the_title(sprintf('<h1 class="post-title-video"><a href="%s">', esc_url(get_permalink())), '</a></h1>'); ?>

            <div class="post-metadata-video">
            ...
            <div class="post-video-excerpt">
                <?php the_excerpt(); ?>
            </div>
            <div class="post-video-readmore">
