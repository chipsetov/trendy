...
<!--                                --><?php //get_template_part('content', get_post_format()); ?>
                    ...
                    <div class="col-sm-10 standard-post">
                            <article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
                                ...
                                <iframe src="https://www.facebook.com/plugins/share_button.php?href=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&layout=box_count&size=small&mobile_iframe=true&width=59&height=40&appId" width="94" height="40" style="border:none;overflow:hidden" scrolling="no" frameborder="0" allowTransparency="true"></iframe>
                                </div>
                                ...
                                <div class="about-author">
                                    ...
                                    <div class="author-description">
                                        ...
                                        <div class="col-sm-6 social-description">
                                            <a href="<?php echo get_the_author_meta( 'facebook_profile' );?>"><i class="fa fa-facebook" aria-hidden="true"></i></a>
                                            <a href="<?php echo get_the_author_meta( 'twitter_profile' );?>"><i class="fa fa-twitter" aria-hidden="true"></i></a>
                                            <a href="<?php echo get_the_author_meta( 'google_profile' );?>"><i class="fa fa-google-plus" aria-hidden="true"></i></a>
                                            <a href="<?php echo get_the_author_meta( 'linkedin_profile' );?>/"><i class="fa fa-linkedin" aria-hidden="true"></i></a>
                                            <a href="<?php echo get_the_author_meta( 'pinterest_profile' );?>"><i class="fa fa-pinterest" aria-hidden="true"></i></a>
                                        </div>
...
<!--                                            </div>-->
                                            <div class="col-xs-12 col-sm-6 relatedcontent">
                                                ...
                                                <a href="<? the_permalink() ?>" rel="bookmark" title="READ MORE">READ
                                                    MORE</a></h3></div>
                                            </div>
